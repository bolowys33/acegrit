...
export function generateHtml(user: User, token: string): string {
     return `
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        ...
        <div class="container">
          ...
          <div class="section-body">
            ...
            <p>
              ...
              <a href="https://blackholemain.onrender.com/api/users/reset_password/?email=${user.email}&token=${token}">
                Click here
              </a>
            </p>
          </div>
