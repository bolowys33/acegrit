                    ...
                    <article>
                        <div className="flex">
                            ...
                            <div className="md:pl-4">
                                <Link href={"#"} className="text-[32px] md:text-[37px] text-start font-extrabold tracking-[1.5px] leading-[44px] hover:text-navy">
                                    Immovable Assets as Securities; The New Era
                                </Link>
                            </div>
                        </div>
                        <p className="text-zinc-400 my-6">
                        Our update pages attempts to keep you abreast with
                        current legislations, policies, pronouncements and
                        events...
                    </p>
                    <Link href={"#"} className="transition duration-300 ease-in-out bg-navy hover:bg-transparent hover:text-navy hover:border-navy border text-white py-2 px-4 font-semibold uppercase">read more</Link>
                    </article>
                    <article>
                        <div className="flex">
                            <div className="py-0 pr-4 border-r-2 h-14 border-navy tracking-[2px] hidden md:block">
